...
pub use model::{
    ...
    Course, Major, MajorRequest, SaveScActivity, SaveScScore, ScActivityItem, ScActivityRequest,
    ScDetail, ScScoreItem, ScScoreItemRequest, SchoolYear, Score, ScoreRequest, Semester,
    TimeTableRequest,
};
