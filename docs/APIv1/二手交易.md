...
- 接口地址：localhost:81/api/v1/mall/insert_wish/{pub_code}
- 请求方式： GET
- 权限： 已登录用户
- 参数：
...
- 请求示例：localhost:81/api/v1/mall/insert_wish/P2021082907666
- JSON返回示例：
```json
//成功示例
{
...
- 接口地址：localhost:81/api/v1/mall/cancel_wish/{pub_code}
- 请求方式：GET
- 权限： 已登录用户
- 说明： 此删除为真正删除不保留数据
- 参数：
