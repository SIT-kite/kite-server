...
- 接口地址：/api/v1/mall/insert_comment
- 请求方式： POST
- 权限： 已登录用户
...
- 接口地址：/api/v1/mall/delete_comment/{com_code}
- 请求方式： GET
- 权限： 已登录用户
...
- 请求示例： /api/v1/mall/delete_comment/C2021082216557
- JSON返回示例：
```json
//成功示例
{
...
- 接口地址：/api/v1/mall/insert_wish/{pub_code}
- 请求方式： GET
- 权限： 已登录用户
- 参数：
...
- 请求示例：/api/v1/mall/insert_wish/P2021082907666
- JSON返回示例：
```json
//成功示例
{
...
- 接口地址：/api/v1/mall/cancel_wish/{pub_code}
- 请求方式：GET
- 权限： 已登录用户
- 说明： 此删除为真正删除不保留数据
- 参数：
...
- 请求示例：/api/v1/mall/cancel_wish/P2021082142635
- JSON返回示例：
```json
//成功示例
{
...
- 接口地址：/api/v1/mall/cancel_wish/{user_code}
- 请求方式：GET
- 权限： 已登录用户
- 参数：
